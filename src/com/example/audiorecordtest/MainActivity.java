...
import com.example.func.BasicClassification;
import com.example.func.BasicFeatureExtractionAE;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelFile = dirPath + "/system/aemodel";
        testFile = dirPath + "/system/singletest";
        findViewByIds();
        setListeners();
        init();
    } 
